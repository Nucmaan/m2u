  ...
  return (
    <div className="flex items-center justify-center h-screen bg-[#F7F7F9] text-center">
      <div className="p-8 bg-white shadow-lg rounded-lg max-w-md w-full">
        ...
        <p className="text-xl text-[#333333] mb-4">Oops! The page you're looking for doesn't exist.</p>
        <p className="text-md text-[#7A7A7A] mb-6">It might have been moved or deleted. Please check the URL or return to the homepage.</p>
