      ...
      <div className="flex-1 p-8 space-y-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-lg text-gray-500 mt-2">Here's an overview of your activities</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 shadow-lg rounded-lg flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{user.stats.activeContracts}</p>
            </div>
            <div className="text-blue-600 text-4xl">📝</div>
          </div>
          ...
          <div className="bg-white p-6 shadow-lg rounded-lg flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{user.stats.outstandingPayments}</p>
            </div>
            <div className="text-blue-600 text-4xl">💸</div>
          </div>
        </div>
          ...
          <ul className="space-y-4">
            {user.recentActivity.map((activity) => (
              <li key={activity.id} className="text-sm text-gray-600">
                ...
                <span className="text-gray-500"> on {new Date(activity.date).toLocaleDateString()}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="bg-white p-6 shadow-lg rounded-lg">
          ...
          <ul className="space-y-4">
            <li className="text-sm text-gray-600">
              <span className="font-semibold">Pay Rent</span> - Due on 2024-11-15
            </li>
            <li className="text-sm text-gray-600">
              <span className="font-semibold">Sign Lease Renewal</span> - Due on 2024-12-01
            </li>
          </ul>
        </div>
      </div>
